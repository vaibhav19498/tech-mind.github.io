        ...
        <div class="container flex flex-column full-width align-items-center">
            <div class="top-section flex flex-column full-width align-items-center">
                <div class="logo-holder">
                    <img src="" class="full-width" alt="techandmind logo">
                </div>
            ...
            <div class="flex flex-column">
                ...
                <div class="flex justify-content-evenly main-ctas">
                    <a class="button button--primary mr-30 main-ctas__button" href="http://www.techandmind.tk">Go to homepage</a>
                </div>
                <div class="main-ctas--mobile full-width justify-content-center">
                    <a class="button button--primary main-ctas__button main-ctas__button--spaced" href="http://www.techandmind.tk">Go to homepage</a>
                </div>
            </div>
        </div>
